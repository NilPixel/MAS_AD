package com.example.zheng.steward.widget.dropMenuView.doubleGrid;
...
public class DoubleGridView extends ScrollView implements View.OnClickListener {
    ...
    @Bind(R.id.grid_top) GridViewInScrollView mTopGrid;
    @Bind(R.id.grid_bottom) GridViewInScrollView mBottomGrid;
    @Bind(R.id.bt_confirm) Button bt_confirm;
